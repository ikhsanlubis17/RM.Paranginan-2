<x-auth-layout>
    <div class="mb-8 text-center">
        ...
        <p class="text-gray-300">Buat akun baru untuk mulai memesan</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <!-- Name -->
        <div class="group">
            <x-input-label for="name" :value="__('Nama Lengkap')" class="text-gray-300 group-focus-within:text-orange-400 transition-colors" />
            <div class="relative">
