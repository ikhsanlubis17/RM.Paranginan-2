                    ...
                    <form action="{{ route('admin.gallery.update', $gallery) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                                    ...
                                    <label for="image" class="cursor-pointer">
                                        ...
                                        <p class="text-lg text-gray-600 mb-2">
                                            {{ $gallery->image ? 'Klik untuk mengganti foto' : 'Klik untuk memilih foto' }}
                                        </p>
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('description', $gallery->description) }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                ...
                                <ul class="text-sm text-blue-800 space-y-1">
                                    <li>• Jika tidak memilih foto baru, foto lama akan tetap digunakan</li>
